...
public class SortByFirstNameDescTest extends TestCase {

    @Test(description = "Sort table by first name descending")
    public void sortByFirstNameDescTest(){
        ...
        webTablesPage.sortColumn(ColumnName.FIRST_NAME, SortingType.DESC);
