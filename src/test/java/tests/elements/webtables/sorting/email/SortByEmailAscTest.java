...
public class SortByEmailAscTest extends TestCase {

    @Test(description = "Sort table by email ascending")
    public void sortByEmailAscTest(){
        ...
        webTablesPage.sortColumn(ColumnName.EMAIL, SortingType.ASC);
        ...
        Assert.assertEquals(firstNameColumnValues, firstNameColumnValues.stream().sorted().toList(),
                "Email column is not sorted in ascending order");
    }
}
